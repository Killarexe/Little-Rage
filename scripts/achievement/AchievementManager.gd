...
const ACHIEVEMENT_DIR: String = "res://data/achievement"
...
func unlock_achievement(achievement_id: String):
	...
	for achievement in achievements:
		if achievement.id == achievement_id:
			...
			PopUpFrame.pop(TranslationServer.translate("ui.popup.unlocked_achievement") % TranslationServer.translate(achievement_id + ".desc"))
			return
